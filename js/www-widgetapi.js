...
if(window.location.protocol.indexOf("http")===0&&window.location.href){c.forigin=window.location.href}else{delete c.forigin}a=window.location.ancestorOrigins;c.aoriginsup=a===void 0?0:1;a&&a.length>0&&(c.aorigins=Array.from(a).join(","));window.document.referrer&&(c.gporigin=window.document.referrer);b&&(c.vf=db(b));return c}
